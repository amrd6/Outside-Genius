...
public class RejDay1 extends ListActivity {
    // Progress Dialog
    ...
    class LoadInbox extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RejDay1.this);
        ...
        protected String doInBackground(String... args) {
            ...
            for (int i = 0; i < SelectArtist.rejectedArtists1.length()-1 ; i++) {

                try {
                    JSONObject a = SelectArtist.rejectedArtists1.getJSONObject(i);
