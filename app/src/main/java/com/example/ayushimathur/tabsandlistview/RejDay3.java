...
public class RejDay3 extends ListActivity {
	// Progress Dialog
	...
	class LoadInbox extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(RejDay3.this);
		...
		protected String doInBackground(String... args) {
			...
			for (int i = 0; i < SelectArtist.rejectedArtists3.length()-1 ; i++) {

				try {
					JSONObject a = SelectArtist.rejectedArtists3.getJSONObject(i);
